...
//  Project6.2
//
//  Created by Vlad Klunduk on 10/08/2023.
//
...
//        let dictionary = ["label1": label1, "label2": label2, "label3": label3, "label4": label4, "label5": label5]
//
...
//        view.addConstraints( NSLayoutConstraint.constraints(withVisualFormat: "V:|-[label1(labelHeight@999)]-[label2(label1)]-[label3(label1)]-[label4(label1)]-[label5(label1)]-(>=10)-|", options: [], metrics: metrics, views: dictionary))
        ...
        for label in [label1, label2, label3, label4, label5] {
            ...
            label.heightAnchor.constraint(equalTo: view.heightAnchor, multiplier: 0.17).isActive = true
